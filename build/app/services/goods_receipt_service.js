...
export default class GoodsReceiptService {
    ...
    static async create({ request, auth }) {
        const { id, supplierName, items, notes, reference, storageId, receivedAt } = await request.validateUsing(goodsReceiptValidator);
...
//# sourceMappingURL=goods_receipt_service.js.map