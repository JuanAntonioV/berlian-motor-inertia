...
export default class ProductService {
    ...
    static async create({ request }) {
        const { name, description, brandId, typeId, categoryIds, retailPrice, salePrice, supplierPrice, wholesalePrice, sku, workshopPrice, } = await request.validateUsing(productValidator);
    ...
    static async getProductStock({ params }) {
        const id = params.id;
        try {
    ...
    static async addProductStock({ params, request }) {
        const id = params.id;
        ...
        try {
            ...
            if (isStockAlreadyExist) {
                return ResponseHelper.badRequestResponse('Maaf, anda hanya bisa menambahkan stok awal sekali!');
            }
